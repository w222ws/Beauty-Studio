...
export default function HeroVictoria() {
  return (
    <section
      className="
        relative flex min-h-[100svh] w-full flex-col justify-end
        overflow-hidden
        bg-[var(--color-bg)] text-[var(--color-ink)]
        selection:bg-[var(--color-emerald-pale)]
        selection:text-[var(--color-emerald-deep)]
    ...
    >
      ...
      <div
        className="
          ...
          h-[62svh] w-full
          sm:h-[68svh]
          lg:bottom-4 lg:left-auto lg:right-6 lg:top-0
          lg:h-[calc(100%-1rem)] lg:w-[48%]
          lg:overflow-hidden
          lg:rounded-b-3xl
          lg:shadow-2xl
          lg:shadow-black/5
      ...
      >
        ...
        {/* М'який градієнт для читабельності тексту на мобільному */}
        <div
          className="
        ...
        {/* Легкий верхній градієнт на мобільному */}
        <div
          className="
            pointer-events-none absolute inset-x-0 top-0 z-10
            h-[18%]
            bg-gradient-to-b
            from-[var(--color-bg)]/12
            to-transparent
            lg:hidden
          "
        />
        ...
        <motion.div
          ...
          className="
            absolute bottom-8 left-8 hidden
            transform-gpu
            rounded-2xl
      ...
      <div
        className="
          ...
          lg:justify-start
          lg:px-16 lg:pb-0 lg:pt-0
        "
      >
        {/* Нижній фон під текстом на мобільному */}
        <div
          className="
            pointer-events-none absolute inset-x-0 bottom-0 -z-10
            h-[75%]
          ...
          >
            <a
              ...
              className="
                ...
                text-[#F5F2EB]
                shadow-md
                shadow-[var(--color-emerald-deep)]/15
                transition-all
                duration-300
            ...
            <a
              ...
              className="
                ...
                sm:w-auto
                sm:py-4
                sm:hover:border-[var(--color-ink)]/40
                sm:hover:bg-[var(--color-ink)]/5
              "
            >
